  ...
  <div>
    ...
    <el-card>
      <el-row :gutter="25">
        <el-col :span="40">
          <!-- 搜索添加 -->
          <el-input placeholder="搜索好友" v-model="queryInfo.query" clearable @clear="getUserList">
      ...
      <el-table :data="userlist" border stripe>
        ...
        <el-table-column label="好友名称" prop="username"></el-table-column>
        <el-table-column label="好友简介" prop="email"></el-table-column>
    ...
    <!-- 创建新用户对话框 -->
    <el-dialog title="添加好友" :visible.sync="addDialogVisible" width="50%"
